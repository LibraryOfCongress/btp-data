Transcription dataset from the Carrie Chapman Catt Papers, Manuscript Division


By the People campaign: Carrie Chapman Catt Papers
Number of transcriptions: 5,760
Dataset created: 2022-10-12

NOTE: A previous version of this dataset from 2020-07-12 did not include the Tags field.


I. About this Dataset

This dataset is an export of transcriptions for 5,760 images from the Carrie Chapman Catt Papers created by volunteers participating in the Library of Congress crowdsourcing program By the People (https://crowd.loc.gov) campaign, Carrie Chapman Catt Papers. It contains text created by volunteers through a transcription and review process, volunteer-created tags, digital collections metadata, and metadata representing the arrangement of the items in the By the People platform, Concordia.
...
This dataset includes transcriptions and data generated from the pages in the By the People campaign Carrie Chapman Catt Papers (https://crowd.loc.gov/campaigns/carrie-chapman-catt-papers/). The campaign consisted of all currently online images of digitized content from the Carrie Chapman Catt Papers (http://hdl.loc.gov/loc.mss/collmss.ms000077) transcribed in their entirety. The papers of suffragist, political strategist, and pacifist Carrie Lane Chapman Catt (1859-1947) span the years 1848-1950 and reflect Catt's steadfast dedication to the rights of women, particularly the right to vote, and world peace. The transcription campaign included the diaries, general correspondence, and speech and article file series of the collection. See the Catt digital collection for all available online items for this collection, as well as contextual information, such as bibliographic resources.


II. What’s included?

This dataset includes:
-	2019667239_v2.zip - a zip file containing a CSV file and a README file
-	carrie-chapman-catt-papers_2022-10-12.csv - a .CSV containing campaign, project, item, itemID, asset, and asset status metadata, as well as an image URL, the volunteer-created transcriptions, and volunteer-created tags.  This .CSV is the direct export of the Carrie Chapman Catt Papers campaign.
...
The Carrie Chapman Catt Papers data were created by 1,039 registered volunteers and an unknown number of anonymous contributors. The Library of Congress thanks all By the People volunteers for sharing their time and knowledge with us. The Carrie Chapman Catt Papers campaign was fully transcribed and reviewed between June 3, 2019 and April 25, 2020.

Following the completion of the entire campaign via the peer review process and review by a subject matter expert, By the People Community Managers exported a CSV report from the campaign to create the file, carrie-chapman-catt-papers_2022-10-12.csv. 
...
-	Campaign – this is the highest hierarchical level in the arrangement of collections on By the People (example: https://crowd.loc.gov/campaigns/carrie-chapman-catt-papers/). This field displays the campaign’s title.
